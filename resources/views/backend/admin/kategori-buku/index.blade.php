      ...
      <div class="col-12">
        <div class="card mb-4">
          <div class="card-header d-flex align-items-center">
            ...
            @include('backend.admin.kategori-buku.modal-create')
              ...
              <table class="table align-items-center mb-0">
                ...
                <tbody>
                    ...
                    @if (count($kategoriBuku))
                        ...
                        <tr>
                        <td>
                            <p class="text-secondary text-xs font-weight-bold mb-0 ps-3">
                                {{ $ids++ }}
                            </p>
                        </td>
                        <td>
                        ...
                        <td class="d-flex gap-2">
                            ...
                            @include('backend.admin.kategori-buku.modal-edit')
                        </td>
                        </tr>
                        @endforeach
                        @else
