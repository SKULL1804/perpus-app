        ...
        <div class="card mb-4">
          <div class="card-body px-0 pt-0 pb-2">
            <div class="container-fluid p-4">
              <form class="row" action="{{ route('admin-kegiatan.update', $kegiatan->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="col-6">
                    <div class="row">
                        <div class="mb-lg-0">
                        ...
                        <div class="mb-lg-0">
                          ...
                          <textarea class="form-control" id="deskripsi_kegiatan" rows="3" name="deskripsi_kegiatan">{{ $kegiatan->deskripsi_kegiatan }}</textarea>
                        </div>
                        <div class="col-6">
                            <div class="mb-0">
