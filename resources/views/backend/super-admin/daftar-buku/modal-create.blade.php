      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="container-fluid px-2">
            <form class="row" method="POST" action="{{ route('daftar-buku.store') }}" enctype="multipart/form-data" id="daftar-buku-form">
                @csrf
              <div class="col-4">
                <div class="mb-lg-0">
              ...
              <div class="col-7">
                <div class="mb-lg-0">
                  <label for="image_buku" class="col-form-label">Upload Img Buku</label>
                  <input type="file" class="form-control" id="image_buku" name="image_buku" />
                  <img id="showimage" src="{{ url('Backend/assets/img/no-image.png') }}" class="img-fluid max-height-200 w-20 mt-3" alt="TEST">
                </div>
              </div>
              <div class="col-5">
                <div class="mb-0">
...
{{-- <script>
    // Skrip yang menangani pengiriman formulir
    document.getElementById('daftar-buku-form').addEventListener('submit', function (event) {
        event.preventDefault();

        // Kirim formulir menggunakan AJAX atau cara lainnya
        fetch('{{ route('daftar-buku.store') }}', {
            method: 'POST',
